...
docker run --rm -u `id -u`:`id -g` -v $dir/src/diagrams:/data -v $dir/src/media:/output minlag/mermaid-cli -i contract-test-http.mmd -o ../output/contract-test-http.svg
docker run --rm -u `id -u`:`id -g` -v $dir/src/diagrams:/data -v $dir/src/media:/output minlag/mermaid-cli -i contract-test-message.mmd -o ../output/contract-test-message.svg
